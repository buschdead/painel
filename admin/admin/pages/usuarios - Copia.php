...
<?php 
	...
	$listagem = array(
		labels=>array("Nome","E-mail", "Telefone", "Celular"),
		campos=>array("nome","email", "telefone", "celular"),
		tipoCampo=>array("titulo", "titulo", "telefone", "imagem"),
		tamanho=>array("25%","20%","15%","15%")
	);
	...
	if(@$_GET["acao"] == 'inserir'){
		...
		$insert = array(
			labels=>array("Nome", "E-mail", "Telefone", "Celular"),
			campos=>array("nome", "email", "telefone", "celular"),
			tipoCampo=>array("titulo", "titulo", "telefone", "arquivo"),
			required=>array("", "nao", "", "nao"),
			maxlength=>array("50", "", "14", ""),
